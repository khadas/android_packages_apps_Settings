...
import com.android.settings.WolSettings;
...
public final class SearchIndexableResources {
    ...
    static {
        ...
        sResMap.put(WolSettings.class.getName(),
                new SearchIndexableResource(
                        Ranking.getRankForClassName(WolSettings.class.getName()),
                        NO_DATA_RES_ID,
                        WolSettings.class.getName(),
                        R.drawable.ic_settings_wol));
