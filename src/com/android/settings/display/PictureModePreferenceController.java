...
public class PictureModePreferenceController extends TogglePreferenceController
    ...
    public PictureModePreferenceController(Context context, String key) {
        super(context, key);
    ...
    public boolean setChecked(boolean isChecked) {
        if(isChecked) {
            ...
            mContrastPreference.setEnabled(true);
            ...
            mRkDisplayOutputManager.setHue(0, 50);
            mRkDisplayOutputManager.setContrast(0, 50);
