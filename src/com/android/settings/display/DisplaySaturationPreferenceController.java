...
public class DisplaySaturationPreferenceController extends SliderPreferenceController {
    ...
    public DisplaySaturationPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public int getSliderPosition() {
        return mRkDisplayOutputManager.getSaturation(0);
    }

    @Override
    public boolean setSliderPosition(int position) {
        Log.d("SettingDisplay", "setSaturation " + position);
        mRkDisplayOutputManager.setSaturation(0, position);
        return true;
    }
